...
<div>
		<form action="signup.php" method="post">
				<label>First Name</label><input type="text" placeholder="First Name" name="first_name"><br>
				<label>Last Name</label><input type="text" placeholder="Last Name" name="last_name"><br>
